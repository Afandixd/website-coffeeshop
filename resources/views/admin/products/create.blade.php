...
<body class="bg-gray-50">
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
            ...
            <h2 class="text-2xl font-bold text-center mb-6">Tambah Produk Baru</h2>
            ...
            <form method="POST" action="{{ url('/admin/products') }}" enctype="multipart/form-data">
                ...
                <!-- Product Image -->
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Gambar Produk (Opsional)</label>
                    <input
                        type="file"
                        name="image"
                        accept="image/*"
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        placeholder="Contoh: Spanish Latte"
                    >
                </div>
